Indeed, to run this application, it’s necessary to use a local server because JavaScript modules (import/export) need to be served over an HTTP server to work correctly.
